...
namespace PlayFab
{
    public class PlayFabApiSettings
    {
        ...
        {
            get { return _requestGetParams; }
        }

        /// <summary> This is only for customers running a private cluster.  Generally you shouldn't touch this </summary>
        public virtual string ProductionEnvironmentUrl
        {
            get { return _ProductionEnvironmentUrl; }
            set { _ProductionEnvironmentUrl = value; }
        }
    ...
    internal class PlayFabSettingsRedirect : PlayFabApiSettings
    {
        ...
        public override string ProductionEnvironmentUrl
        {
            ...
            {
                var so = GetSO();
                return so == null ? base.ProductionEnvironmentUrl : so.ProductionEnvironmentUrl;
            }
            set
            {
                var so = GetSO();
                if (so != null) so.ProductionEnvironmentUrl = value;
        ...
        internal override string VerticalName
        {
            ...
            {
                var so = GetSO();
                return so == null ? base.VerticalName : so.VerticalName;
            }
            set
            {
                var so = GetSO();
                if (so != null) so.VerticalName = value;
        ...
        public override string DeveloperSecretKey
        {
            ...
            {
                var so = GetSO();
                return so == null ? base.DeveloperSecretKey : so.DeveloperSecretKey;
            }
            set
            {
                var so = GetSO();
                if (so != null) so.DeveloperSecretKey = value;
                base.DeveloperSecretKey = value;
            }
        }
#endif
        ...
        public override string TitleId
        {
            ...
            {
                var so = GetSO();
                return so == null ? base.TitleId : so.TitleId;
            }
            set
            {
                var so = GetSO();
                if (so != null) so.TitleId = value;
                base.TitleId = value;
            }
        }
        ...
        public override bool DisableDeviceInfo
        {
            ...
            {
                var so = GetSO();
                return so == null ? base.DisableDeviceInfo : so.DisableDeviceInfo;
            }
            set
            {
                var so = GetSO();
                if (so != null) so.DisableDeviceInfo = value;
        ...
        public override bool DisableFocusTimeCollection
        {
            ...
            {
                var so = GetSO();
                return so == null ? base.DisableFocusTimeCollection : so.DisableFocusTimeCollection;
            }
            set
            {
                var so = GetSO();
                if (so != null) so.DisableFocusTimeCollection = value;
